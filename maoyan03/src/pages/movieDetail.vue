<template>
  <div>
    ...
    <div v-if="isReady">
        <topTitle :showBack="true">{{movieDetail.nm}}</topTitle>

        <div class="movie-header">
        <div class="bg-second"></div>
        <div class="bg-last"></div>
        <div class="movie-img" @click="showPlayVD = !showPlayVD">
    ...
    <!-- 播放那个电影宣传片 -->
    <div class="play-vd" v-if="showPlayVD" @click="showPlayVD=!showPlayVD">
